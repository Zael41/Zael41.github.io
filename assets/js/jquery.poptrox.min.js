    ...
    (e.fn.poptrox_disableSelection = function () {
        ...
        (e.fn.poptrox = function (o) {
            ...
            var p,
                ...
                l = e(window),
                u = [],
                z = ["https://store.steampowered.com/app/1454960/Dark_Sky/", "https://github.com/Zael41/TileDrafting", "https://zael41.itch.io/test-shooter", "https://github.com/Zael41/Acrobatic-Racing", "https://github.com/Zael41/RailGrind", "https://github.com/Zael41/TFGStealth", "https://drive.google.com/file/d/1toZ_K8uTRDDMEgx9DJpH0XbJNrar3bLX/view?usp=sharing", "https://github.com/Zael41/NinjaRun"]
                d = 0,
                h = !1,
                g = new Array(),
                f = function () {
                    ...
                    b
                        ...
                        .on("startSpinning", function (o) {
                            ...
                            t
                                ...
                                .css(
                                    "margin-top",
                                    Math.floor((x.height() - t.height() + (m.length > 0 ? m.height() : 0)) / 2)
                                )
            ...
            return (
                ...
                s.usePopupEasyClose
                    ? (m.on("click", "a", function (e) {
                      ...
                      x.css("cursor", "pointer").on("click", function (e) {
                          e.stopPropagation(), e.preventDefault(), x.trigger("poptrox_link");
                      }))
                ...
                r.find(s.selector).each(function (o) {
                    ...
                    if ("ignore" != n && i.attr("href")) {
                        ...
                        if (!t.type)
                            switch (
                                ((p = t.src.match(/\/\/([a-z0-9\.]+)\/.*/)), (!p || p.length < 2) && (p = [!1]), p[1])
                            ) {
                        ...
                        switch (((p = t.src.match(/\/\/[a-z0-9\.]+\/(.*)/)), t.type)) {
                            ...
                            default:
                                if (
                                    ((t.object = e('<img src="" alt="" style="vertical-align:bottom" />')), s.preload)
                                ) {
